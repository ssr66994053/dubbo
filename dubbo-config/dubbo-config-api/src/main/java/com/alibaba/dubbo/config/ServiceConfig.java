...
//                    logger.info("Export dubbo service " + interfaceClass.getName() + " to url " + url.toServiceString());
//                }
                if (registryURLs != null && registryURLs.size() > 0
                    ...
                    for (URL registryURL : registryURLs) {
                        ...
                        if (logger.isInfoEnabled()) {
                            logger.info("Register dubbo service " + interfaceClass.getName() +  " to registry " + registryURL.getAddress());
                        }
