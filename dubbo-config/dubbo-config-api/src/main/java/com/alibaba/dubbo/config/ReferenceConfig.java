...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
    ...
    public synchronized void destroy() {
        // 当init时，服务不存在，ref==null，但此时应该让invoker可以清理资源
        //if (ref == null) {
        //    return;
        //}
        if (destroyed){
	...
	private T createProxy(Map<String, String> map) {
        ...
        if (logger.isInfoEnabled()) {
            logger.info("Refer dubbo service " + interfaceClass.getName() + " from " + (invoker.getUrl() == null ? null : invoker.getUrl().getAddress()));
        }
        // 创建服务代理
