...
public final class URL implements Serializable {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((parameters == null) ? 0 : parametersHashCode(parameters));
    ...
    public boolean equals(Object obj) {
        ...
        if (parameters == null) {
            if (other.parameters != null)
                return false;
        } else if (!comapareParameters(parameters, other.parameters))
            return false;
        if (password == null) {
    ...
    /**
     * 比较parameter，忽略timestamp
     */
    private boolean comapareParameters(Map<String, String> parameter1, Map<String, String> parameter2) {
        ...
        Map<String, String> pMap1 = new HashMap<String, String>(parameter1);
        pMap1.remove("timestamp");
        Map<String, String> pMap2 = new HashMap<String, String>(parameter2);
        pMap2.remove("timestamp");
        return pMap1.equals(pMap2);
    }

    /**
     * 计算parameter，忽略timestamp
     */
    private int parametersHashCode(Map<String, String> parameters) {
        if (parameters == null) {
            return 0;
        }
        Map<String, String> pMap1 = new HashMap<String, String>(parameters);
        pMap1.remove("timestamp");
